"""Participant discovery metadata for the docs participant."""
...
from participant_docs.service.executor import DEFAULT_PRIVACY_CLASS, DOMAIN_ID, PARTICIPANT_ID

SUPPORTED_TOOLS: tuple[str, ...] = (
    "local_docs.load_docs",
    "local_docs.search_docs",
)
PROFILE_DESCRIPTION = (
    "Local document and runbook participant for architecture, policy, and design context."
)
STATUS_NOTE = "Ready for interactive local document queries."
