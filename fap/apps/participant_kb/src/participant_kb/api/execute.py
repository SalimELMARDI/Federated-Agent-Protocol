"""Execution routes for the participant_kb service."""
...
from participant_kb.service.executor import ParticipantExecutionResult, execute_task_create

router = APIRouter()


class ExecuteResponse(BaseModel):
    """Canonical execution response bundle for participant_kb."""
