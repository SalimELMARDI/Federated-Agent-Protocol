"""Tests for the coordinator protocol ingress endpoint."""
...
def build_envelope(message_type: MessageType, *, sender_id: str, recipient_id: str) -> MessageEnvelope:
    """Return a valid envelope for coordinator API tests."""
...
def test_health_endpoint_still_works() -> None:
    """Coordinator health route should still be available."""
