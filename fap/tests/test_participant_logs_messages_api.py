"""Tests for the participant_logs protocol ingress endpoint."""
...
def build_envelope(message_type: MessageType, *, sender_id: str, recipient_id: str) -> MessageEnvelope:
    """Return a valid envelope for participant_logs API tests."""
...
def build_task_create_message() -> TaskCreateMessage:
    ...
    return TaskCreateMessage(
        ...
        payload=TaskCreatePayload(
            ...
            requested_capabilities=["logs.search", "logs.events"],
            input_query="privacy",
